...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2020 a las 23:36:07
...
CREATE TABLE `precipitaciones` (
  `idPrecipitacion` int(11) NOT NULL,
  `idGenPrecipitacion` varchar(50) NOT NULL,
  `fechaPrecipitacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `usuarios` (`idUsuario`, `idNivel`, `idGenUsuario`, `imgPerfil`, `nombreCompleto`, `apellido`, `usuario`, `password`, `activado`, `email`, `telefono`, `fechaCreacion`, `eliminado`) VALUES
(2, 0, 'dVWIyzs2mTVMneA', '300.png', 'Root', 'Admin', 'root', '81dc9bdb52d04dc20036dbd8313ed055', 1, 'root@prueba.com', '3333333333', '2019-12-16 19:41:08', 0);
...
ALTER TABLE `precipitaciones`
  ADD PRIMARY KEY (`idPrecipitacion`);
...
--
ALTER TABLE `precipitaciones`
  MODIFY `idPrecipitacion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `provincias`
--
ALTER TABLE `provincias`
  MODIFY `idProvincia` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
