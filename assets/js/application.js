$(function() {
    ...
    window.onload = function() {
        tableListadoPrecipitaciones = $('#listado_precipitaciones').DataTable();
        $("#listado_precipitaciones").dataTable().fnDestroy();
        $('#listado_precipitaciones').DataTable({
            "sAjaxSource": URL + "precipitaciones/listar_precipitaciones_table",
            "bSort": true,
            "lengthMenu": [
                [10, 25, 50, -1],
                [10, 25, 50, "Todos"]
